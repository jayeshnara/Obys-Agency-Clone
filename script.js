...
function cursorAnimation() {
  ...
  // Shery.mouseFollower({
  //   skew: true,
  //   ease: "cubic-bezier(0.25,1,0.23,1)",
  //   duration:1,
  // });
...
function sheryAnimantion() {
  Shery.imageEffect(".image-div ", {
    ...
    config: {
      ...
      aspect: { value: 0.7999781801536503 },
      ...
      onMouse: { value: 1 },
      noise_speed: { value: 3.74, range: [0, 10] },
      metaball: { value: 0.29, range: [0, 2] },
